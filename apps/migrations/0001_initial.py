    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('admin', 'Admin'), ('moderator', 'Admin'), ('job', 'Job'), ('student', 'Student')], db_default='student', max_length=15)),
                ('image', models.ImageField(default='users/default-avatar.jpg', upload_to='users/%Y/%m/%d/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=255)),
                ('price', models.FloatField(help_text='Product narxi uzb somda')),
